...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary selection:text-white">
      ...
      {/* Content Container - with dark gradient overlay for readability */}
      <div className="relative z-10 bg-gradient-to-b from-transparent via-background/90 to-background">
        ...
        <section id="menu" className="py-32 px-6 md:px-12 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <MenuItem 
              ...
              img={sushiImg} // Reuse for mockup
              delay={0.8}
            />
          </div>
          
          <div className="text-center mt-16">
            <button className="text-accent hover:text-white transition-colors font-serif-jp tracking-widest text-sm border-b border-accent pb-1">
              VIEW FULL MENU
            </button>
          </div>
        </section>

        {/* About Section - Bushido */}
        <section id="story" className="py-32 bg-secondary/30 relative overflow-hidden">
           ...
           <div className="max-w-5xl mx-auto">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
               ...
               <motion.div 
                 ...
                 className="bg-black/40 backdrop-blur-xl border border-white/10 p-8 md:p-12 relative overflow-hidden"
               >
                 {/* Neon Border Effect */}
